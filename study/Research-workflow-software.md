...
| `IDE`     | [`lazyvim`](https://www.lazyvim.org/)                |             | Y (latex)    | Y (mindmap + latex table) |
| `IDE`     | [`wps`](https://www.wps.cn/)                         |             |              | Y (ppt)                   |
| `IDE`     | [`tencent-doc`](https://docs.qq.com/)                | Y (excel)   |              | Y (ppt)                   |
...
| `Tool`    | [`mubu`](https://mubu.com/)                          |             |              | Y                         |
| `Tool`    | [`fmread`](https://www.fmread.com/)                  | Y           |              |                           |
